            ...
            <div class="px-2 px-md-3 col-2 col-sm-1 col-lg-3 vh-100 border-right dashboard_side_bar">
                <ul class="ps-lg-4">
                     <li class="my-4 d-flex justify-content-center justify-content-lg-start">
                          <a href="/dashboard" class="d-flex justify-content-center justify-content-lg-start align-items-center text-decoration-none ps-lg-4 active"> <span>
                     ...
                     <li class="my-4 d-flex justify-content-center justify-content-lg-start">
                          <a href="{{ route("dashboard.orders") }}" class="d-flex justify-content-center justify-content-lg-start align-items-center text-decoration-none ps-lg-4">
