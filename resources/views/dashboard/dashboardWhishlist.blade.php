    ...
    <div class="row w-100 m-0">
        ...
        <div class="px-2 px-md-3 col-2 col-sm-1 col-lg-3 vh-100 border-right dashboard_side_bar">
            <ul class="ps-lg-4">
                 ...
                 <li class="my-4 d-flex justify-content-center justify-content-lg-start">
                    ...
                    @endphp
                      <a href="{{ route('dashboard.products')  }}" class="d-flex justify-content-center justify-content-lg-start align-items-center text-decoration-none pl-lg-4 " > <span>
                 ...
                 <li class="my-4 d-flex justify-content-center justify-content-lg-start">
                    <a href="{{ route("dashboard.whishlist") }}" class="d-flex justify-content-center justify-content-lg-start align-items-center text-decoration-none ps-lg-4 active">
        ...
        <div class="py-7 dashboard_part2 col-10 col-sm-11  col-lg-9">
            <div class="px-3 px-sm-5">
                    ...
                    <h1 class="mb-2 mx-0">Whishlist</h1>
                    <p class="dashboard_intro">All your whishlist products</p>
