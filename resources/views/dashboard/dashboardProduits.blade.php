    ...
    <div class="row w-100 m-0">
        ...
        <div class="px-2 px-md-3 col-2 col-sm-1 col-lg-3 vh-100 border-right dashboard_side_bar">
            <ul class="ps-lg-4">
                 ...
                 <li class="my-4 d-flex justify-content-center justify-content-lg-start">
                    ...
                    @endphp
                      <a href="{{ route('dashboard.products')  }}" class="d-flex justify-content-center justify-content-lg-start align-items-center text-decoration-none pl-lg-4 active" > <span>
                 ...
                 <li class="my-4 d-flex justify-content-center justify-content-lg-start">
                    <a href="{{ route("dashboard.whishlist") }}" class="d-flex justify-content-center justify-content-lg-start align-items-center text-decoration-none ps-lg-4">
                 ...
                 <li class="my-4 d-flex justify-content-center justify-content-lg-start">
                      <a href="{{ route("dashboard.orders") }}" class="d-flex justify-content-center justify-content-lg-start align-items-center text-decoration-none pl-lg-4"> <span>
        ...
        <div class="py-7 dashboard_part2 col-10 col-sm-11 px-0  col-lg-9">
            <div class="px-3 px-sm-5">
                    ...
                    <p class="dashboard_intro">All your products</p>

                    {{--   Flash messages  --}}

                    <div class="container w-100 flashMessages justify-content-center mt-3" style="transition: all .5s ease-in-out">
                        @include('flashMessages.flash')
                    </div>

                    <div class="mt-5 add_product px-0 px-md-4 mx-md-1 d-flex justify-content-start">
                        <a href=" {{ route('dashboard.manageProducts.addproduct') }} " class="btn btn-success mr-5 d-flex justify-content-center align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16" style="font-weight: 600">
                            <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                          </svg><span class="ms-2">Add new product</span></a>
                    </div>
