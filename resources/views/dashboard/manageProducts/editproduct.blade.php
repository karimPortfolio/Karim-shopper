        ...
        <div class="mx-auto editing_products_panel">
            ...
            <div class="d-flex">
                ...
                <div class="my-5 col-lg-7 d-flex justify-content-center align-items-center addProductDashboard">
                    <form action=" {{ route('dashboard.manageProducts.updateproduct', $product->id) }}" method="post"
                        enctype="multipart/form-data" accept="images/*" style="width: 500px">
                        @csrf
                        <div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Product name</label>
                                <input type="text" class="form-control" name="product_name"
                                    value="{{ $product->product_name }}" id="exampleInputEmail1"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="product_discount"
                                    id="exampleInputEmail1" value = " {{ $product->product_discount }} "
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Brand</label>
                                <input type="text" class="form-control" name="brand"
                                    id="exampleInputEmail1" value = " {{ $product->brand }} "
                                    aria-describedby="emailHelp">
                            </div>
                        </div>
                        <div class="mb-3 d-flex flex-column">
                            ...
                            <select class="form-select form-select-lg mb-3" name="category"
                                value = " {{ $product->category }} " aria-label=".form-select-lg example">
                        ...
                        <div class="mb-3">
                            ...
                            <br>
                            <label for="formFile"
                                class="form-label btn btn-success d-flex justify-content-center align-items-center"
                                style="height: 50px"><i class="fa-solid fa-image mr-3" style="font-size: 20px"></i>Add
                                Product Image</label>
                        ...
                        <div>
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="desc" cols="30" rows="5">{{ $product->description }}</textarea>
                        </div>

                        <button type="submit" class="btn btn-primary w-100 mt-5 btnAddProduct">Edit</button>
                    </form>
                </div>
            </div>
