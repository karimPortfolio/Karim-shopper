        ...
        {{-- <div class="col-12 ">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-5">
                    ...
                    <li class="breadcrumb-item"><a href="/" class="text-success text-decoration-none">Product Detail</a>
                    </li>
                            ...
                            <td class="">
                                <div class="d-flex justify-content-center align-items-center">
                                    ...
                                    <button wire:loading.attr="disabled"
                                        wire:click="decreaseQty({{ $product->cart_id}}) class=" m-0
                                        lessQuantityBtn">-</button>
                                    ...
                                    <button wire:loading.attr="disabled" wire:click="increaseQty({{ $product->cart_id }})"
                                        class="m-0 moreQuantityBtn">+</button>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="table_delete_row">
                                <form action="{{ route("cart.destroy", $product->cart_id) }}" method="post">
                                    ...
                                    <button type="submit"
                                        ...
                                        style="width: fit-content"><i class="far fa-trash-alt"></i></button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
        ...
        <div class="col-lg-4 mx-md-5 px-4 px-sm-5 mx-lg-0 px-lg-0 mt-5 mt-lg-0 pl-lg-5">
            <div class="sumarry_card p-3 border rounded">
                    ...
                    <tr style="height: 50px;vertical-align:bottom;">
                        ...
                        @if (!empty($product->price))
                            <td class="text-right"><strong>
                                    ${{ $product->price * $totalPrice[0]->total_quantity + 3 }}.00</strong></td>
                        @else
                            <td class="text-right">$0.00</td>
                        @endif
                ...
                <div class="mt-4 go_to_pay_btn">
                    @if (!empty($product->price))
                        <a href="/checkout"
                            class="w-100 py-3 btn btn-success d-flex justify-content-between"><span><strong>Go to
                                    pay</strong></span>
                            <span><strong>${{ $product->price * $totalPrice[0]->total_quantity + 3 }}.00</strong></span>
                        </a>
                    @else
                        <button class="w-100 py-3 btn btn-success d-flex justify-content-between disabled"><span><strong>Go
                                    to pay</strong></span> <span><strong>$0.00</strong></span> </button>
                    @endif
