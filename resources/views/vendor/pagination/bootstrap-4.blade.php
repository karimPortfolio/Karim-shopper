        ...
        <ul class="pagination">
            ...
            @if ($paginator->onFirstPage())
                <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                    <span class="page-link text-success" aria-hidden="true">&laquo;</span>
                </li>
            @else
                <li class="page-item">
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li class="page-item active" aria-current="page"><span class="page-link bg-success border-success rounded-full">{{ $page }}</span></li>
                        @else
            ...
            @else
                <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
                    <span class="page-link text-success" aria-hidden="true">&raquo;</span>
                </li>
            @endif
        </ul>
    </div>
